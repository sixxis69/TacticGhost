package tacticghost.maps.core
{
	...
	public class WalkPlane extends Plane
	{
		private static const IMG_PATH:String = 'assets/walk.png'
		...
		public function WalkPlane(name:String="", width:Number=10, height:Number=10, segments:int=1, material:Material3D=null, axis:String="+xz")
		{
